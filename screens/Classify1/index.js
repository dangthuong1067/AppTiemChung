...
const Classify1Screen = () => {
    ...
    let obj = infoData10?.filter(obj => obj?.KetQua === "Đủ điều kiện tiêm");
    ...
    const renderEmty = () => {
        return (
            <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 200 }}>
                <Text style={{ fontSize: 30, fontWeight: 'bold' }}>Chưa có ai được khám</Text>
            </View>
        )
    }
    return (
...
export default Classify1Screen
